...
export const useNotificationsStore = create<NotificationsState>((set, get) => ({
  items: [
    ...
    { id: '1', title: 'Welcome to Your Wallet', body: 'Your wallet is ready. Add money to get started!', icon: '👋', type: 'info', read: false, createdAt: new Date(Date.now() - 3600000).toISOString(), actionPath: '/wallet/add-money', actionLabel: 'Add Money' },
